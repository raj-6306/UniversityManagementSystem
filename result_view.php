...
<?php
global $con;
$sql="select * from marks Where m_st_id='$_SESSION[stu_id]'";
$rs=mysqli_query($con,$sql) or die(mysqli_error($con));
while($data=mysqli_fetch_assoc($rs)){
...
<font color="red" size="+2">Important Information</font><br />
    1)If your marks is less than 45% than you are in D grade.<br>
    2)If your marks is greater than 45% and less than 60% than you are in C grade.<br>
    3)If your marks is greater than 60% and less than 75% than you are in B grade.<br>
    4)If your marks is greater than 75% and less than 90%  than you are in A grade.<br>
    5)If your marks is greater than 90% and less than 100% than you are in A+ grade.<br>

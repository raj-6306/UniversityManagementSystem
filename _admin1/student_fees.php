...
<form action="lib/student.php" method="post" enctype="multipart/form-data" name="student_fees" id="student_fees" >
  <table width="1441" border="1" class="tbl">
    <tr>
      <th width="263" height="26"><div align="center">Name</div></th>
      <th width="313"><div align="center">Father Name </div></th>
      <th width="325"><div align="center">Gender</div></th>
      <th width="305"><div align="center">Course</div></th>
      <th width="201"><div align="center">Action</div></th>
    </tr>
	<?php
